    ...
    <div class="create-container">
        <div class="container">
            ...
            <div class="create-header">
                <h1><i class="fas fa-plus-circle"></i> Tambah Posisi Baru</h1>
                <p class="subtitle mb-0">Tambahkan posisi jabatan baru ke dalam sistem</p>
            </div>
                ...
                <form action="{{ route('positions.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        @error('gaji_pokok')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">Format: 5000000 (tanpa titik atau koma)</small>
                    </div>
